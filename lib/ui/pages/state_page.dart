...
import 'package:covid_self_care_app/ui/widgets/state_details.dart';
...
class StatePage extends StatelessWidget {
  ...
  const StatePage({required Key key, required this.title, required this.stateData}) : super(key: key);
              ...
              child: ListView(
                ...
                children: <Widget>[
                  ...
                  WidgetEnterAnimation(
                    delay: 0,
                    child: StateDetails(
                      stateData: stateData, key: ObjectKey("sd"),
                    ),
                  ),
                ],
              ),
