...
class DailyStateCombinedChart extends StatefulWidget {
  ...
  DailyStateCombinedChart({required Key key, required this.statePatientDataMap}) : super(key: key) {
...
class _DailyStateCombinedChartState extends State<DailyStateCombinedChart> {
            ...
            children: <Widget>[
              ...
              Expanded(
                child: TouchedDataCapsule(
                  ...
                  color: Colors.amberAccent[700]!, key: ObjectKey("tdc2"),
                ),
              ),
              Expanded(
                child: TouchedDataCapsule(
                  ...
                  color: Colors.greenAccent[700]!, key: ObjectKey("tdc3"),
                ),
              ),
              Expanded(
                child: TouchedDataCapsule(
                  ...
                  color: Colors.redAccent, key: ObjectKey("tdc4"),
                ),
              ),
            ],
          ),
    ...
    return LineChartBarData(
      ...
      dotData: FlDotData(
        ...
        getDotPainter: (FlSpot flSpot, __, LineChartBarData lineChartBarData, ___){
          FlDotCirclePainter dotCirclePainter = FlDotCirclePainter();
          dotCirclePainter.strokeWidth = 0;
          dotCirclePainter.strokeColor = (touchedSpotXValue == flSpot.x && isSpotSelected) ? chartColor : chartColor.withOpacity(0.75);
          dotCirclePainter.color = (touchedSpotXValue == flSpot.x && isSpotSelected) ? chartColor : chartColor.withOpacity(0.75);
          dotCirclePainter.radius = getDotSize(selectedValue);
  ...
  int getMaxSingleDayDailyDataValue({required List<MyStateSingleValue> cnfData, required List<MyStateSingleValue> activeData, required List<MyStateSingleValue> rcvrdData, required List<MyStateSingleValue> deathsData}) {
    // int maxValue = 0;
