...
class LineChartCumulative extends StatefulWidget {
  ...
  LineChartCumulative({required Key key, required this.name, required this.totalValue, required this.dailyData, required this.chartColor}) : super(key: key);
                ...
                children: <Widget>[
                  ...
                  isSpotSelected
                      ? DateValue(
                          ...
                          chartColor: chartColor, key: ObjectKey("dv"),
                        )
                      : Container(
                          height: 28,
                        ),
  ...
  LineChartData buildLineChart(List<SingleDayData> singleDayData, BuildContext context) {
    ...
    return LineChartData(
      lineTouchData: LineTouchData(
        ...
        touchCallback: (FlTouchEvent flTouchEvent, touchResponse) {
        ...
        touchTooltipData: LineTouchTooltipData(
            ...
            getTooltipItems: (lineBarSpotList) {
              List<LineTooltipItem> lineToolTipItems = [];
