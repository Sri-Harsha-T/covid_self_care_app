...
import 'package:covid_self_care_app/ui/pages/state_page.dart';
...
class PatientDataTable extends StatefulWidget {
  ...
  PatientDataTable({required Key key, required this.stateWiseData, required this.isStateDataTable}) : super(key: key);
                ...
                Navigator.push(
                  ...
                  MaterialPageRoute(
                    builder: (context) => StatePage(
                      ...
                      stateData: stateData, key: ObjectKey("sp"),
                    ),
