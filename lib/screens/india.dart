...
import 'package:covid_self_care_app/components/pieChart_data.dart';
...
class _IndiaState extends State<India> {
  ...
  Future getIndiaData() async {
    final response= await http.get('https://disease.sh/v3/covid-19/countries/India' as Uri);
  ...
  Future getStatesData()async{
    final response = await http.get('https://api.covid19india.org/data.json' as Uri);
